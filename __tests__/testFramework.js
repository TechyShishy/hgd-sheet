 ...
 */
const environment = {
  attributes:{"sheet_version":"0","Heckin_Good_Doggos_tab":"nav-tabs-heckin-good-doggos--main","description":"","breed":"","name":"","best-friend":"","help-by":"","neighborhood":"","brawn_max":"0","brawn":"0","performing":"0","staying":"0","sneaking":"0","smarts_max":"0","smarts":"0","sensing":"0","knowing":"0","fiddling":"0","guts_max":"0","guts":"0","investigating":"0","sniffing":"0","surviving":"0","pawsize":"4","template_start":"@{whisper}&{template:Heckin_Good_Doggos} {{character_name=@{character_name}}} {{character_id=@{character_id}}}"},
  triggers: [],
  translation,
  otherCharacters: {
...
//# sourceURL=Heckin_Good_Doggos.js
  
  const k = (function(){
  const kFuncs = {};
  
  const cascades = {"attr_character_name":{"name":"character_name","type":"text","defaultValue":"","affects":[],"triggeredFuncs":["setActionCalls"],"listenerFunc":"accessSheet","listener":"change:character_name"},"act_k-network-call":{"name":"k-network-call","type":"action","triggeredFuncs":["kReceive"],"affects":[],"addFuncs":[],"listener":"clicked:k-network-call","listenerFunc":"accessSheet","defaultValue":"","calculation":"","initialFunc":"","formula":""},"attr_sheet_version":{"name":"sheet_version","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:sheet_version","listenerFunc":"accessSheet","defaultValue":0,"calculation":"","initialFunc":"","formula":""},"attr_heckin_good_doggos_tab":{"name":"heckin_good_doggos_tab","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:heckin_good_doggos_tab","listenerFunc":"accessSheet","defaultValue":"nav-tabs-heckin-good-doggos--main","calculation":"","initialFunc":"","formula":""},"act_nav-tabs-heckin-good-doggos--main":{"name":"nav-tabs-heckin-good-doggos--main","type":"action","triggeredFuncs":["kSwitchTab"],"affects":[],"addFuncs":[],"listener":"clicked:nav-tabs-heckin-good-doggos--main","listenerFunc":"accessSheet","defaultValue":"","calculation":"","initialFunc":"","formula":""},"act_nav-tabs-heckin-good-doggos--settings":{"name":"nav-tabs-heckin-good-doggos--settings","type":"action","triggeredFuncs":["kSwitchTab"],"affects":[],"addFuncs":[],"listener":"clicked:nav-tabs-heckin-good-doggos--settings","listenerFunc":"accessSheet","defaultValue":"","calculation":"","initialFunc":"","formula":""},"attr_description":{"name":"description","type":"span","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:description","listenerFunc":"accessSheet","defaultValue":"","calculation":"","initialFunc":"","formula":""},"attr_breed":{"name":"breed","type":"span","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:breed","listenerFunc":"accessSheet","defaultValue":"","calculation":"","initialFunc":"","formula":""},"attr_name":{"name":"name","type":"span","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:name","listenerFunc":"accessSheet","defaultValue":"","calculation":"","initialFunc":"","formula":""},"attr_best-friend":{"name":"best-friend","type":"span","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:best-friend","listenerFunc":"accessSheet","defaultValue":"","calculation":"","initialFunc":"","formula":""},"attr_help-by":{"name":"help-by","type":"span","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:help-by","listenerFunc":"accessSheet","defaultValue":"","calculation":"","initialFunc":"","formula":""},"attr_neighborhood":{"name":"neighborhood","type":"span","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:neighborhood","listenerFunc":"accessSheet","defaultValue":"","calculation":"","initialFunc":"","formula":""},"attr_brawn_max":{"name":"brawn_max","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:brawn_max","listenerFunc":"accessSheet","defaultValue":0,"calculation":"","initialFunc":"","formula":""},"attr_brawn":{"name":"brawn","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:brawn","listenerFunc":"accessSheet","defaultValue":0,"calculation":"","initialFunc":"","formula":""},"attr_performing":{"name":"performing","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:performing","listenerFunc":"accessSheet","defaultValue":0,"calculation":"","initialFunc":"","formula":""},"attr_staying":{"name":"staying","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:staying","listenerFunc":"accessSheet","defaultValue":0,"calculation":"","initialFunc":"","formula":""},"attr_sneaking":{"name":"sneaking","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:sneaking","listenerFunc":"accessSheet","defaultValue":0,"calculation":"","initialFunc":"","formula":""},"attr_smarts_max":{"name":"smarts_max","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:smarts_max","listenerFunc":"accessSheet","defaultValue":0,"calculation":"","initialFunc":"","formula":""},"attr_smarts":{"name":"smarts","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:smarts","listenerFunc":"accessSheet","defaultValue":0,"calculation":"","initialFunc":"","formula":""},"attr_sensing":{"name":"sensing","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:sensing","listenerFunc":"accessSheet","defaultValue":0,"calculation":"","initialFunc":"","formula":""},"attr_knowing":{"name":"knowing","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:knowing","listenerFunc":"accessSheet","defaultValue":0,"calculation":"","initialFunc":"","formula":""},"attr_fiddling":{"name":"fiddling","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:fiddling","listenerFunc":"accessSheet","defaultValue":0,"calculation":"","initialFunc":"","formula":""},"attr_guts_max":{"name":"guts_max","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:guts_max","listenerFunc":"accessSheet","defaultValue":0,"calculation":"","initialFunc":"","formula":""},"attr_guts":{"name":"guts","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:guts","listenerFunc":"accessSheet","defaultValue":0,"calculation":"","initialFunc":"","formula":""},"attr_investigating":{"name":"investigating","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:investigating","listenerFunc":"accessSheet","defaultValue":0,"calculation":"","initialFunc":"","formula":""},"attr_sniffing":{"name":"sniffing","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:sniffing","listenerFunc":"accessSheet","defaultValue":0,"calculation":"","initialFunc":"","formula":""},"attr_surviving":{"name":"surviving","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:surviving","listenerFunc":"accessSheet","defaultValue":0,"calculation":"","initialFunc":"","formula":""},"attr_pawsize":{"name":"pawsize","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:pawsize","listenerFunc":"accessSheet","defaultValue":0,"calculation":"","initialFunc":"","formula":""},"attr_template_start":{"name":"template_start","type":"hidden","triggeredFuncs":[],"affects":[],"addFuncs":[],"listener":"change:template_start","listenerFunc":"accessSheet","defaultValue":"@{whisper}&{template:Heckin_Good_Doggos} {{character_name=@{character_name}}} {{character_id=@{character_id}}}","calculation":"","initialFunc":"","formula":""}};
  ...
  const persistentTabs = ["Heckin_Good_Doggos_tab"];
